...
<div class="row text-center mb-3">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 79">
            <div class="card-body">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 78">
            <div class="card-body">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 77">
            <div class="card-body">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 76">
            <div class="card-body">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 75">
            <div class="card-body">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="<?=_ASSETS_IMAGES_FOLDER_?>default-book.jpg" class="card-img-top" alt="Test 74">
            <div class="card-body">
